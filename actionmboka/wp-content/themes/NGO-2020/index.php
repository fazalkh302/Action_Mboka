...
<!-- <section class="hero-header w-100 pb-5">
    <div id="HeroCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <span class="bg-highlighter"></span>
            <div class="carousel-item active">
                <img src="<?php bloginfo('template_url');?>/assets/images/hero.jpg" class="d-block w-100" alt="">
            </div>
            <div class="carousel-item">
                <img src="<?php bloginfo('template_url');?>/assets/images/c2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
...
<div id="carouselExampleCaptions" class="carousel slide slider-responsive mb-5" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="<?php bloginfo('template_url');?>/assets/images/w4.png" class="d-block w-100" alt="">
      <div class="carousel-caption d-none d-md-block">
...
<!-- <div class="container-fluid hero-img" style="margin-bottom: 3rem;">
    <div class="container" style="margin-top: 4.6rem;">
        <div class="row">
            <div class="col-12 ml-auto my-auto">
                <h1 class="display-2 text-white myfont1">Habitate for Humanity Donations</h1>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="col-lg-12">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <p class="text-center font-small text-muted">To use the font for an HTML element, refer to the name of
                    the font break <br> after through the font-family property:</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-deck">
        ...
        <div class="card">
            ...
            <div class="card-body col-sm rounded-lg shadow">
                ...
                <!-- <div class="col">
                    <div class="row">
                        <h6 class="font-small mr-auto">Raised: $20,99</h6>
                        <h6 class="font-small"> Goal: $15,99</h6>
                    </div>
                </div> -->
            </div>
        </div>
...
<!-- END - Main-Container of what-we-doo -->
